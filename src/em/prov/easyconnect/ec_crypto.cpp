...
// int ec_crypto::compute_key_hash(EC_KEY *key, uint8_t *digest, const char *prefix)
// {
//     BIO *bio;
//     uint8_t *asn1;
//     int asn1len;
...
//  */
// int ec_crypto::compute_hkdf_key(uint8_t *key_out, int key_out_len, const char *info_str,
...
// int ec_crypto::compute_intermediate_key(bool is_first)
// {       
//     // The key to store
...
// BIGNUM* ec_crypto::calculate_Lx(const BIGNUM* bR, const BIGNUM* pR, const EC_POINT* BI)
// {
//     EC_POINT* L = NULL;
...
//  */
// int ec_crypto::compute_ke(uint8_t *ke_buffer)
// {
