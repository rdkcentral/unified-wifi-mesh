...
em_cmd_ap_cap_report_t::em_cmd_ap_cap_report_t(em_cmd_params_t param, dm_easy_mesh_t& dm)
{
    em_cmd_ctx_t ctx;;

    m_type = em_cmd_type_ap_cap_query;
    memcpy(&m_param, &param, sizeof(em_cmd_params_t));

    m_orch_op_idx = 0;
    m_num_orch_ops = 1;
    m_orch_op_array[0] = dm_orch_type_ap_cap_report;
