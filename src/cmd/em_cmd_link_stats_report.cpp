...
em_cmd_link_stats_report_t::em_cmd_link_stats_report_t(em_cmd_params_t param, dm_easy_mesh_t& dm)
{
    em_cmd_ctx_t ctx;

    m_type = em_cmd_type_get_link_stats_alarm_report;
    ...
    m_orch_op_idx = 0;
    m_num_orch_desc = 1;
    m_orch_desc[0].op = dm_orch_type_link_stats_report;
