...
em_cmd_scan_channel_t::em_cmd_scan_channel_t(em_cmd_params_t param, dm_easy_mesh_t& dm)
{
    em_cmd_ctx_t ctx;;

    m_type = em_cmd_type_scan_channel;
    ...
    m_orch_op_idx = 0;
    m_num_orch_desc = 1;
    m_orch_desc[0].op = dm_orch_type_channel_scan_req;
    m_orch_desc[0].submit = true;

    strncpy(m_name, "scan_channel", strlen("scan_channel") + 1);
