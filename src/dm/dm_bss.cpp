...
void dm_bss_t::operator = (const dm_bss_t& obj)
{
    ...
    memcpy(&this->m_bss_info.mesh_ap_passphrase, &obj.m_bss_info.mesh_ap_passphrase, sizeof(em_short_string_t));
...
bool dm_bss_t::operator == (const dm_bss_t& obj)
{
    ...
    ret += (memcmp(&this->m_bss_info.mesh_ap_passphrase, &obj.m_bss_info.mesh_ap_passphrase, sizeof(em_short_string_t)) != 0);
