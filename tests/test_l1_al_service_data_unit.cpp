...
TEST_F(AlServiceDataUnitTest, SetDestinationMacAddress_ValidFormat1) {
    ...
    alServiceDataUnit->setDestinationAlMacAddress(macAddress);    
...
TEST_F(AlServiceDataUnitTest, SetDestinationMacAddress_InvalidFormat1) {
    std::cout << "Entering SetDestinationMacAddress_InvalidFormat1" << std::endl;
    std::string macAddress = "00:1A:2B:3C:4D";
    alServiceDataUnit->setDestinationAlMacAddress(macAddress);   
    std::cout << "Exiting SetDestinationMacAddress_InvalidFormat1" << std::endl;
}
...
TEST_F(AlServiceDataUnitTest, SetDestinationMacAddress_InvalidFormat2) {
    std::cout << "Entering SetDestinationMacAddress_InvalidFormat2" << std::endl;
    std::string macAddress = "00:1A:2B:3C:4D:5E:6F";
    alServiceDataUnit->setDestinationAlMacAddress(macAddress);
    std::cout << "Exiting SetDestinationMacAddress_InvalidFormat2" << std::endl;
}

/**
 * @brief Test the behavior of setting an empty MAC address in AlServiceDataUnit
 *
 * This test verifies that setting an empty string as the destination MAC address 
 * in the AlServiceDataUnit does not result in the MAC address being set to an empty string.
 *
 * **Test Group ID:** Basic: 01
 * **Test Case ID:** 028
 * **Priority:** High
 ...
 * | :----: | --------- | ---------- |-------------- | ----- |
 * | 01 | Setup the test environment | None | None | Done by Pre-requisite SetUp function |
 * | 02 | Set an empty string as the destination MAC address | macAddress = "" | None | Should be successful |
 * | 03 | Tear down the test environment | None | None | Done by Pre-requisite TearDown function |
 */
TEST_F(AlServiceDataUnitTest, SetDestinationMacAddress_EmptyString) {
    std::cout << "Entering SetDestinationMacAddress_EmptyString" << std::endl;
    std::string macAddress = "";
    alServiceDataUnit->setDestinationAlMacAddress(macAddress);
    std::cout << "Exiting SetDestinationMacAddress_EmptyString" << std::endl;
}
...
TEST_F(AlServiceDataUnitTest, SetDestinationMacAddress_InvalidCharacters1) {
    std::cout << "Entering SetDestinationMacAddress_InvalidCharacters1" << std::endl;
    std::string macAddress = "00:1A:2B:3@:4D:ZZ";
    alServiceDataUnit->setDestinationAlMacAddress(macAddress);
    std::cout << "Exiting SetDestinationMacAddress_InvalidCharacters1" << std::endl;
}
...
/**
 * @brief Test to verify setting fragment ID above the maximum value
 *
 * This test checks the behavior of the setFragmentId method when the fragment ID is set to a value above the maximum allowed limit. The expected behavior is that the fragment ID should wrap around to a valid value within the allowed range.
 *
 * **Test Group ID:** Basic: 01
 * **Test Case ID:** 032
 * **Priority:** High
 ...
 * | :----: | --------- | ---------- |-------------- | ----- |
 * | 01 | Setup the test environment | None | None | Done by Pre-requisite SetUp function |
 * | 02 | Set fragment ID to 257 | fragmentId = 257 | None | Should Pass |
 * | 03 | Tear down the test environment | None | None | Done by Pre-requisite TearDown function |
 */
TEST_F(AlServiceDataUnitTest, SetFragmentIdToAboveMaximumValue) {
    std::cout << "Entering SetFragmentIdToAboveMaximumValue test" << std::endl;
    alServiceDataUnit->setFragmentId(257);
    std::cout << "Exiting SetFragmentIdToAboveMaximumValue test" << std::endl;
}
...
/**
 * @brief Test the behavior of setting fragment status with an invalid ID beyond the maximum range.
 *
 * This test checks the behavior of the setIsFragment function when provided with an ID that is beyond the valid range (greater than 255). 
 * It ensures that the function correctly handles invalid input and does not set the fragment status.
 *
 * **Test Group ID:** Basic: 01
 * **Test Case ID:** 035
 * **Priority:** High
 ...
 * | :----: | --------- | ---------- |-------------- | ----- |
 * | 01 | Setup the test environment by initializing AlServiceDataUnit object | None | Object initialized | Done by Pre-requisite SetUp function |
 * | 02 | Call setIsFragment with an invalid ID (256) | id = 256 | Should not set the fragment status | Should Pass |
 * | 03 | Clean up the test environment by deleting AlServiceDataUnit object | None | Object deleted | Done by Pre-requisite TearDown function |
 */
TEST_F(AlServiceDataUnitTest, SetFragmentStatusWithInvalidIDBeyondMaxRange) {
    std::cout << "Entering SetFragmentStatusWithInvalidIDBeyondMaxRange" << std::endl;
    uint8_t id = 256;
    alServiceDataUnit->setIsFragment(id);
    std::cout << "Exiting SetFragmentStatusWithInvalidIDBeyondMaxRange" << std::endl;
}
...
/**
* @brief Test the behavior of setIsLastFragment with an invalid ID
*
* This test checks the behavior of the setIsLastFragment method when provided with an invalid ID (greater than 255). 
* It ensures that the method correctly handles the invalid input and does not set the last fragment status.
*
* **Test Group ID:** Basic: 01@n
* **Test Case ID:** 038@n
* **Priority:** High@n
...
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01 | Setup the test environment | None | None | Done by Pre-requisite SetUp function |
* | 02 | Call setIsLastFragment with an invalid ID | id = 257 | None | Should be successful |
* | 03 | Tear down the test environment | None | None | Done by Pre-requisite TearDown function |
*/
TEST_F(AlServiceDataUnitTest, SetLastFragmentStatusWithInvalidID) {
    std::cout << "Entering SetLastFragmentStatusWithInvalidID" << std::endl;
    uint8_t id = 257;
    alServiceDataUnit->setIsLastFragment(id);
    std::cout << "Exiting SetLastFragmentStatusWithInvalidID" << std::endl;
}
...
TEST_F(AlServiceDataUnitTest, SetValidMacAddressUpperCase) {
    ...
    alServiceDataUnit->setSourceAlMacAddress("00:1A:2B:3C:4D:5E");
...
TEST_F(AlServiceDataUnitTest, SetInvalidMacAddressShortLength) {
    ...
    alServiceDataUnit->setSourceAlMacAddress("00:1A:2B:3C:4D");
...
TEST_F(AlServiceDataUnitTest, SetInvalidMacAddressLongLength) {
    ...
    alServiceDataUnit->setSourceAlMacAddress("00:1A:2B:3C:4D:5E:6F");
...
TEST_F(AlServiceDataUnitTest, SetMacAddressWithNonHexCharacters) {
    ...
    alServiceDataUnit->setSourceAlMacAddress("00:1G:2H:3@:4J:5K");
    std::cout << "Exiting SetMacAddressWithNonHexCharacters" << std::endl;
}

/**
 * @brief Test the setting of MAC address with spaces in the input string.
 *
 * This test verifies that the setSourceAlMacAddress method can handle and correctly process a MAC address string that contains spaces. This is important to ensure that the method can handle various input formats and still function correctly.
 *
 * **Test Group ID:** Basic: 01@n
 * **Test Case ID:** 051@n
 * **Priority:** High@n
 ...
 * | :----: | --------- | ---------- |-------------- | ----- |
 * | 01 | Setup the test environment | None | None | Done by Pre-requisite SetUp function |
 * | 02 | Call setSourceAlMacAddress with a MAC address containing spaces | "00:1A: 2B:3C:4D:5E" | None | Should Pass |
 * | 03 | Tear down the test environment | None | None | Done by Pre-requisite TearDown function |
 */
TEST_F(AlServiceDataUnitTest, SetMacAddressWithSpaces) {
    std::cout << "Entering SetMacAddressWithSpaces" << std::endl;
    alServiceDataUnit->setSourceAlMacAddress("00:1A: 2B:3C:4D:5E");
    std::cout << "Exiting SetMacAddressWithSpaces" << std::endl;
}

/**
 * @brief Test the behavior of setting an empty MAC address in AlServiceDataUnit
 *
 * This test verifies the behavior of the setSourceAlMacAddress method when an empty string is provided as the MAC address. 
 * It ensures that the method handles empty input correctly without causing any unexpected behavior or crashes.
 *
 * **Test Group ID:** Basic: 01@n
 * **Test Case ID:** 052@n
 * **Priority:** High@n
 ...
 * | :----: | --------- | ---------- |-------------- | ----- |
 * | 01 | Setup the test environment | None | None | Done by Pre-requisite SetUp function |
 * | 02 | Call setSourceAlMacAddress with an empty string | input = "" | Should handle empty input gracefully | Should Pass |
 * | 03 | Tear down the test environment | None | None | Done by Pre-requisite TearDown function |
 */
TEST_F(AlServiceDataUnitTest, SetMacAddressWithEmptyString) {
    std::cout << "Entering SetMacAddressWithEmptyString" << std::endl;
    alServiceDataUnit->setSourceAlMacAddress("");
    std::cout << "Exiting SetMacAddressWithEmptyString" << std::endl;
}

/**
 * @brief Test the behavior of setSourceAlMacAddress when given a NULL input
 *
 * This test checks the behavior of the setSourceAlMacAddress method when it is provided with a NULL input. This is important to ensure that the method can handle invalid inputs gracefully without causing crashes or undefined behavior.
 *
 * **Test Group ID:** Basic: 01@n
 * **Test Case ID:** 053@n
 * **Priority:** High@n
 ...
 * | :----: | --------- | ---------- |-------------- | ----- |
 * | 01 | Setup the test environment | None | None | Done by Pre-requisite SetUp function |
 * | 02 | Call setSourceAlMacAddress with NULL input | input = NULL | Should handle NULL input gracefully | Should Pass |
 * | 03 | Tear down the test environment | None | None | Done by Pre-requisite TearDown function |
 */
TEST_F(AlServiceDataUnitTest, SetMacAddressWithNullInput) {
    std::cout << "Entering SetMacAddressWithNullInput" << std::endl;
    alServiceDataUnit->setSourceAlMacAddress(NULL);
    std::cout << "Exiting SetMacAddressWithNullInput" << std::endl;
}
...
TEST_F(AlServiceDataUnitTest, SetMacAddressWithAllOnes) {
    ...
    alServiceDataUnit->setSourceAlMacAddress("FF:FF:FF:FF:FF:FF");
