...
/**
* @brief Test to compare two different affiliated APs
*
* This test checks the equality operator for two dm_ap_mld_t objects with different affiliated APs. The objective is to ensure that the equality operator correctly identifies that the two objects are not equal when their affiliated APs have different values.
*
* **Test Group ID:** Basic: 01@n
* **Test Case ID:** 023@n
* **Priority:** High@n
...
* | Variation / Step | Description | Test Data |Expected Result |Notes |
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01| Initialize two dm_ap_mld_t objects with different affiliated APs | obj1.m_ap_mld_info.affiliated_ap[0].some_field = 1, obj2.m_ap_mld_info.affiliated_ap[0].some_field = 2 | Objects should be initialized with different values | Should be successful |
* | 02| Compare the two objects using the equality operator | obj1 == obj2 | EXPECT_FALSE(obj1 == obj2) | Should Pass |
*/
TEST(dm_ap_mld_tTest, CompareDifferentAffiliatedAp) {
    std::cout << "Entering CompareDifferentAffiliatedAp test";
    dm_ap_mld_t obj1, obj2;
    obj1.m_ap_mld_info.affiliated_ap[0].some_field = 1;
    obj2.m_ap_mld_info.affiliated_ap[0].some_field = 2;
    EXPECT_FALSE(obj1 == obj2);
    std::cout << "Exiting CompareDifferentAffiliatedAp test";
}
...
TEST(dm_ap_mld_tTest, ValidAPMLDInformation) {
    ...
    ASSERT_EQ(ap_mld.m_ap_mld_info.emlstr, true);
...
TEST(dm_ap_mld_tTest, InvalidMACAddress) {
    ...
    em_ap_mld_info_t ap_mld_info = {
        .mac_addr_valid = true,
        .ssid = "TestSSID",
        .mac_addr = {0x00, 0x1A, 0x2B, 0x3C, 0x4D},
        .str = true,
        .nstr = false,
        .emlsr = true,
        .emlmr = false,
...
* | Variation / Step | Description | Test Data | Expected Result | Notes |
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01 | Initialize em_ap_mld_info_t with maximum affiliated APs | mac_addr_valid = true, ssid = "TestSSID", mac_addr = {0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E}, str = true, nstr = false, emlsr = true, emlmr = false, num_affiliated_ap = EM_MAX_AP_MLD | Should initialize successfully | Should be successful |
...
TEST(dm_ap_mld_tTest, MaximumNumberOfAffiliatedAPs) {
    ...
    em_ap_mld_info_t ap_mld_info = {
        ...
        .emlsr = true,
        .emlmr = false,
        .num_affiliated_ap = EM_MAX_AP_MLD
    };
    dm_ap_mld_t ap_mld(&ap_mld_info);
...
* | Variation / Step | Description | Test Data | Expected Result | Notes |
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01 | Initialize `em_ap_mld_info_t` with zero affiliated APs | mac_addr_valid = true, ssid = "TestSSID", mac_addr = {0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E}, str = true, nstr = false, emlsr = true, emlmr = false, num_affiliated_ap = 0 | Object should be initialized successfully | Should be successful |
