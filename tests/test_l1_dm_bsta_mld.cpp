...
TEST(dm_bsta_mld_Test, RetrieveAPMLDInfoWithValidData) {
  ...
  /**
   * @briefTEST to retrieve AP MLD information after null initialization
   *
   * ThisTEST verifies that the AP MLD information is correctly retrieved and initialized to default values after the instance is initialized. It ensures that all fields are set to their expected default states.
   *
   * **Test Group ID:** Basic: 01
   * **Test Case ID:** 012
   * **Priority:** High
