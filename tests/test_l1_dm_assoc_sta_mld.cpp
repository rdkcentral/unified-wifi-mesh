...
* | Variation / Step | Description | Test Data | Expected Result | Notes |
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01 | Initialize obj1 with specific affiliated station values | obj1.m_assoc_sta_mld_info = {{0x00, 0x11, 0x22, 0x33, 0x44, 0x55}, {0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB}, true, false, true, false, 1, {{0x01, 0x02, 0x03, 0x04, 0x05, 0x06}}} | Object initialized | Should be successful |
* | 02 | Initialize obj2 with different affiliated station values | obj2.m_assoc_sta_mld_info = {{0x00, 0x11, 0x22, 0x33, 0x44, 0x55}, {0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB}, true, false, true, false, 1, {{0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C}}} | Object initialized | Should be successful |
...
TEST(dm_assoc_sta_mld_t_Test, DifferentAffiliatedStaValues) {
    ...
    dm_assoc_sta_mld_t obj1, obj2;
    obj1.m_assoc_sta_mld_info = {{0x00, 0x11, 0x22, 0x33, 0x44, 0x55}, {0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB}, true, false, true, false, 1, {{0x01, 0x02, 0x03, 0x04, 0x05, 0x06}}};
    obj2.m_assoc_sta_mld_info = {{0x00, 0x11, 0x22, 0x33, 0x44, 0x55}, {0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB}, true, false, true, false, 1, {{0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C}}};
    EXPECT_FALSE(obj1 == obj2);
