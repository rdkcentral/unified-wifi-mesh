...
TEST(dm_network_ssid_t_Test, ValidJsonObjectWithValidParentID) {
    ...
    int result = ssid.decode(obj, static_cast<void*>(parent_str));
    EXPECT_EQ(result, 0);
    cJSON_Delete(obj);
...
TEST(dm_network_ssid_t_Test, NullJsonObject) {
    ...
    const char* parent_str = "parent_1";
    dm_network_ssid_t ssid;
    int result = ssid.decode(nullptr, static_cast<void*>(parent_str));
    EXPECT_EQ(result, -1);
...
TEST(dm_network_ssid_t_Test, JsonObjectWithInvalidType) {
    ...
    dm_network_ssid_t ssid;
    int result = ssid.decode(&obj, static_cast<void*>(parent_id));
    EXPECT_EQ(result, -1);
...
TEST(dm_network_ssid_t_Test, JsonObjectWithArray) {
    ...
    const void* parent_id = "parent_1";
    dm_network_ssid_t ssid;
    int result = ssid.decode(array, static_cast<void*>(parent_id));
    EXPECT_EQ(result, 0);
    cJSON_Delete(array);
