...
TEST(db_column_tTest, AssignValidDbColumn) {
    ...
    db_column_t col2;
    col2 = col1;
    EXPECT_STREQ(col2.m_name, "column1");
 ...
 * | 04 | Verify the name of the second object | col2.m_name | col2.m_name != "" | Should Fail |
 ...
 * | 03| Verify the name of the assigned object | input: col2.m_name | Expected: not equal to "a_very_long_column_name_exceeding_normal_length" | Should Fail |
 ...
 * | 04| Check the name attribute of col2 | EXPECT_STREQ(col2.m_name, "column2") | col2.m_name should be "column2" | Should Pass |
...
TEST(db_column_tTest, AssignDifferentDataTypesDbColumn) {
    ...
    db_column_t col2;
    col2 = col1;
    EXPECT_STREQ(col2.m_name, "column2");
...
TEST(db_column_tTest, AssignZeroTypeArgsDbColumn) {
    ...
    db_column_t col2;
    col2 = col1;
    EXPECT_STREQ(col2.m_name, "column4");
...
TEST(db_column_tTest, SelfAssignmentDbColumn) {
    ...
    col1 = col1;
    EXPECT_STREQ(col1.m_name, "column6");
 ...
 * | 03| Verify the name attribute of the assigned object | input: col2.m_name | Expected: Not equal to "col@mn#7$" | Should Fail |
 ...
 * | 04| Verify the name of the second object | col2.m_name | not equal to nullptr | Should Fail |
 ...
 * | 02 | Check if column.m_name matches the expected name | name = "column1" | EXPECT_STREQ(column.m_name, name) | Should Pass |
...
TEST(db_column_tTest, ValidNameValidTypeValidArgs) {
    std::cout << "Entering ValidNameValidTypeValidArgs test" << std::endl;
    ...
    std::cout << "Exiting ValidNameValidTypeValidArgs test" << std::endl;
}
...
TEST(db_column_tTest, ValidNameValidTypeZeroArgs) {
    std::cout << "Entering ValidNameValidTypeZeroArgs test" << std::endl;
    ...
    EXPECT_EQ(column.m_type, type);
    EXPECT_EQ(column.m_type_args, args);
    std::cout << "Exiting ValidNameValidTypeZeroArgs test" << std::endl;
}
 ...
 * | 02 | Check if column.m_name matches the provided name | name != "" | EXPECT_STRNE(column.m_name, name) | Should Fail |
...
TEST(db_column_tTest, EmptyNameValidTypeValidArgs) {
    std::cout << "Entering EmptyNameValidTypeValidArgs test" << std::endl;
...
TEST(db_column_tTest, ValidNameValidTypeBoundaryArgs1) {
    std::cout << "Entering ValidNameValidTypeBoundaryArgs1 test" << std::endl;
    ...
    EXPECT_EQ(column.m_type, type);
    EXPECT_EQ(column.m_type_args, args);
    std::cout << "Exiting ValidNameValidTypeBoundaryArgs1 test" << std::endl;
}
...
TEST(db_column_tTest, ValidNameValidTypeBoundaryArgs2) {
    std::cout << "Entering ValidNameValidTypeBoundaryArgs2 test" << std::endl;
    ...
    EXPECT_EQ(column.m_type, type);
    EXPECT_EQ(column.m_type_args, args);
    std::cout << "Exiting ValidNameValidTypeBoundaryArgs2 test" << std::endl;
}
