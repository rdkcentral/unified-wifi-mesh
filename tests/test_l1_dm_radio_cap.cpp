...
TEST(dm_radio_cap_t_Test, CopyConstructorWithValidInput) {
    ...
    ASSERT_EQ(copy.m_radio_cap_info.wifi7_cap.radios_num, original.m_radio_cap_info.wifi7_cap.radios_num);
    ASSERT_EQ(copy.m_radio_cap_info.ch_scan.enabled, original.m_radio_cap_info.ch_scan.enabled);
...
*/
TEST(dm_radio_cap_test, EncodeValidStringValue) {
...
*/
TEST(dm_radio_cap_test, EncodeValidNumberValue) {
...
*/
TEST(dm_radio_cap_test, EncodeValidIntegerValue) {
...
*/
TEST(dm_radio_cap_test, EncodeValidBooleanValue) {
...
*/
TEST(dm_radio_cap_test, EncodeValidNullValue) {
...
*/
TEST(dm_radio_cap_test, EncodeValidArray) {
...
*/
TEST(dm_radio_cap_test, EncodeInvalidType) {
...
*/
TEST(dm_radio_cap_test, EncodeNullPointer) {
...
TEST(dm_radio_cap_t_Test, RetrieveRadioCapInfoWithMaxMinValues) {
    ...
    ASSERT_EQ(result->wifi7_cap.radios_num, 255);
    ASSERT_EQ(result->ht_cap.max_sprt_tx_streams, 3);
    ASSERT_EQ(result->ht_cap.max_sprt_rx_streams, 3);
    ASSERT_EQ(result->vht_cap.max_sprt_tx_streams, 7);
    ASSERT_EQ(result->vht_cap.max_sprt_rx_streams, 7);
    ASSERT_EQ(result->he_cap.max_sprt_tx_streams, 7);
    ASSERT_EQ(result->he_cap.max_sprt_rx_streams, 7);
    ASSERT_EQ(result->wifi6_cap.max_dl_mumimo_tx, 15);
    ASSERT_EQ(result->wifi6_cap.max_ul_mumimo_rx, 15);
    ASSERT_EQ(result->wifi6_cap.max_dl_ofdma_tx, 255);
    ASSERT_EQ(result->wifi6_cap.max_ul_ofdma_rx, 255);
...
TEST(dm_radio_cap_t_Test, AssigningInvalidValue) {
    ...
    dm_radio_cap_t obj1;
    dm_radio_cap_t obj2; 
    // Assign an invalid value to obj2's media field
...
*/
TEST(dm_radio_cap_tTest, CompareIdenticalObjects) {
...
*/
TEST(dm_radio_cap_tTest, CompareDifferentNumberOfBSS) {
...
*/
TEST(dm_radio_cap_tTest, CompareDifferentMediaType) {
...
* | 03 | Compare obj1 and obj2 using equality operator | obj1, obj2 | EXPECT_FALSE(obj1 == obj2) | Should Pass |
*/
TEST(dm_radio_cap_tTest, CompareDifferentEnabledValue) {
...
* | 03 | Compare `obj1` and `obj2` using equality operator | obj1, obj2 | EXPECT_FALSE(obj1 == obj2) | Should Pass |
*/
TEST(dm_radio_cap_tTest, CompareDifferentChipVendor) {
    std::cout << "Entering CompareDifferentChipVendor" << std::endl;
    dm_radio_cap_t obj1;
    dm_radio_cap_t obj2;
    strcpy(obj2.m_radio_cap_info.ch_scan.chip_vendor, "VendorX");
    EXPECT_FALSE(obj1 == obj2);
...
* | 03| Compare obj1 and obj2 using equality operator | obj1 == obj2 | EXPECT_FALSE(obj1 == obj2) | Should Pass |
*/
TEST(dm_radio_cap_tTest, CompareDifferentBSSColorBitmap) {
...
TEST(dm_radio_cap_tTest, CompareDifferentQosMap) {
...
*/
TEST(dm_radio_cap_tTest, CompareDifferentMetricInterval) {
...
* | 03 | Compare obj1 and obj2 using equality operator | obj1 == obj2 | EXPECT_FALSE(obj1 == obj2) | Should Pass |
*/
TEST(dm_radio_cap_tTest, CompareDifferentEHTOpsReserved) {
...
*/
TEST(dm_radio_cap_tTest, CompareDifferentEHTCap) {
