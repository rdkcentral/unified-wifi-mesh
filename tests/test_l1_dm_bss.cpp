...
TEST_F(dm_bss_t_Test, AddValidVendorIE) {
     ...
     struct ieee80211_vs_ie valid_ie = {0xDD, 5, {0x00, 0x50, 0xF2}, 1, 1, {0x01, 0x02, 0x03, 0x04, 0x05}};
...
TEST_F(dm_bss_t_Test, AddVendorIEWIthZeroLength) {
     ...
     struct ieee80211_vs_ie zero_length_ie = {0xDD, 0, {0x00, 0x50, 0xF2}, 1, 1, {}};
...
TEST_F(dm_bss_t_Test, AddVendorIEWIthMaximumLength) {
     ...
     struct ieee80211_vs_ie max_length_ie = {0xDD, 255, {0x00, 0x50, 0xF2}, 1, 1, {}};
...
TEST_F(dm_bss_t_Test, AddVendorIEWIthEmptyPayload) {
     ...
     struct ieee80211_vs_ie empty_payload_ie = {0xDD, 5, {0x00, 0x50, 0xF2}, 1, 1, {}};
...
TEST_F(dm_bss_t_Test, ParseBssIdWithEmptyKeyString) {
  ...
  * | :----: | --------- | ---------- |-------------- | ----- |
  * | 01 | Setup theTEST environment | None | None | Done by Pre-requisite SetUp function |
  * | 02 | Define a key with special characters | key = "key_with_special_chars!@#$" | None | Should be successful |
  * | 03 | Call `parse_bss_id_from_key` with the special character key | key = "key_with_special_chars!@#$", id = &id | result = -1 | Should Pass |
...
TEST_F(dm_bss_t_Test, RemoveVendorIEWIthMaximumLength) {
     ...
     ieee80211_vs_ie max_length_ie = {0xDD, 255, {0x00, 0x50, 0xF2}, 1, 0, {0}};
...
TEST_F(dm_bss_t_Test, RemoveVendorIEWIthInvalidOUI) {
     ...
     ieee80211_vs_ie invalid_oui_ie = {0xDD, 5, {0xFF, 0xFF, 0xFF}, 1, 0, {0x01, 0x02, 0x03}};
...
TEST_F(dm_bss_t_Test, RemoveVendorIEWIthInvalidType) {
     ...
     ieee80211_vs_ie invalid_type_ie = {0xDD, 5, {0x00, 0x50, 0xF2}, 0xFF, 0, {0x01, 0x02, 0x03}};
...
TEST_F(dm_bss_t_Test, RemoveVendorIEWIthInvalidSubtype) {
     ...
     ieee80211_vs_ie invalid_subtype_ie = {0xDD, 5, {0x00, 0x50, 0xF2}, 1, 0xFF, {0x01, 0x02, 0x03}};
...
TEST_F(dm_bss_t_Test, RemoveVendorIEWIthEmptyPayload) {
     ...
     ieee80211_vs_ie empty_payload_ie = {0xDD, 5, {0x00, 0x50, 0xF2}, 1, 0, {}};
...
TEST(dm_bss_t_Test, CompareDifferentDevMac) {
     ...
     dm_bss_t obj1;
     dm_bss_t obj2;
     memcpy(obj1.m_bss_info.id.dev_mac, (unsigned char[]){0x00, 0x11, 0x22, 0x33, 0x44, 0x55}, 6);
     memcpy(obj2.m_bss_info.id.dev_mac, (unsigned char[]){0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB}, 6);
     EXPECT_FALSE(obj1 == obj2);
...
TEST(dm_bss_t_Test, CompareDifferentRuid) {
     ...
     dm_bss_t obj1;
     dm_bss_t obj2;
     memcpy(obj1.m_bss_info.id.ruid, (unsigned char[]){0x00, 0x11, 0x22, 0x33, 0x44, 0x55}, 6);
     memcpy(obj2.m_bss_info.id.ruid, (unsigned char[]){0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB}, 6);
     EXPECT_FALSE(obj1 == obj2);
...
TEST(dm_bss_t_Test, CompareDifferentBssid) {
     ...
     dm_bss_t obj1;
     dm_bss_t obj2;
     memcpy(obj1.m_bss_info.id.bssid, (unsigned char[]){0x00, 0x11, 0x22, 0x33, 0x44, 0x55}, 6);
     memcpy(obj2.m_bss_info.id.bssid, (unsigned char[]){0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB}, 6);
     EXPECT_FALSE(obj1 == obj2);
