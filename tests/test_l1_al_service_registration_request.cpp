...
TEST(AlServiceRegistrationRequestTest, RetrieveServiceOperationWhenEnabled) {
    ...
    AlServiceRegistrationRequest instance(ServiceOperation::SOP_ENABLE, service operation::BASIC);
	service operation operation = instance->getServiceOperation()
...
TEST(AlServiceRegistrationRequestTest, RetrieveServiceOperationWhenDisabled) {
	...
	AlServiceRegistrationRequest instance(ServiceOperation::SOP_DISABLE, service operation::BASIC);
	service operation operation = instance->getServiceOperation()
    std::cout << "The service operation is "  << operation << std::endl;
...
TEST(AlServiceRegistrationRequestTest, RetrieveServiceOperationWhenInvalid) {
    ...
    AlServiceRegistrationRequest instance(static_cast<ServiceOperation>(0x03), service operation::BASIC);
	service operation operation = instance->getServiceOperation()
    std::cout << "The service operation is "  << operation << std::endl;
