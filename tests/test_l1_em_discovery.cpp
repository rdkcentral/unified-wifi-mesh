...
public:
  ...
  em_mgr_t* get_mgr() override { return nullptr; }
};
 ...
 *
 * This test verifies that the object created in the test fixture is successfully instantiated.
 *
 ...
 * | :----: | --------- | ---------- |-------------- | ----- |@n
 * | 01     | Create the discovery object | discovery pointer initialized via default constructor | No exception is thrown | Should Pass|
 */
...
TEST_F(emDiscoveryTest, em_discovery_t_destructor_cleanup) {
    ...
    EXPECT_NO_THROW({
		Dummy_em_discovery_t* instance = new Dummy_em_discovery_t();
