...
// Test Case 1:
// Constructor with valid service type (em_service_type_ctrl) and fully‐initialized parameters  
//
/**
...
TEST(em_cmd_cfg_renew_t, em_cmd_cfg_renew_t_valid_ctrl)
{
    ...
    strncpy(parameters.u.args.fixed_args, "TestCtrl",
            sizeof(parameters.u.args.fixed_args) - 1);
    parameters.u.args.fixed_args[sizeof(parameters.u.args.fixed_args) - 1] = '\0';
    parameters.u.args.num_args = 1;

    dm_easy_mesh_t dm{};
    strncpy(dm.m_network.m_net_info.id, "NetworkID_CTRL",
            sizeof(dm.m_network.m_net_info.id) - 1);
    ...
    std::cout << "Constructor invoked with service = "
              ...
              << ", fixed_args = " << cmd.m_param.u.args.fixed_args
...
TEST(em_cmd_cfg_renew_t, em_cmd_cfg_renew_t_valid_agent)
{
    ...
    em_cmd_params_t parameters = {};
    strncpy(parameters.u.args.fixed_args, "AgentParam",
            sizeof(parameters.u.args.fixed_args) - 1);
    parameters.u.args.fixed_args[sizeof(parameters.u.args.fixed_args) - 1] = '\0';
    parameters.u.args.num_args = 1;

    dm_easy_mesh_t dm{};
    strncpy(dm.m_network.m_net_info.id, "NetworkID_AGENT",
            sizeof(dm.m_network.m_net_info.id) - 1);
    dm.m_network.m_net_info.id[sizeof(dm.m_network.m_net_info.id) - 1] = '\0';
...
TEST(em_cmd_cfg_renew_t, em_cmd_cfg_renew_t_valid_cli)
{
    ...
    em_cmd_params_t parameters = {};
    strncpy(parameters.u.args.fixed_args, "CliFixedArg",
            sizeof(parameters.u.args.fixed_args) - 1);
    parameters.u.args.fixed_args[sizeof(parameters.u.args.fixed_args) - 1] = '\0';
    parameters.u.args.num_args = 1;

    dm_easy_mesh_t dm{};
    strncpy(dm.m_network.m_net_info.id, "NetworkID_CLI",
            sizeof(dm.m_network.m_net_info.id) - 1);
    dm.m_network.m_net_info.id[sizeof(dm.m_network.m_net_info.id) - 1] = '\0';
    ...
    EXPECT_EQ(cmd.m_svc, em_service_type_cli);
...
TEST(em_cmd_cfg_renew_t, em_cmd_cfg_renew_t_valid_none)
{
    ...
    dm_easy_mesh_t dm{};
    strncpy(dm.m_network.m_net_info.id, "NetworkID_NONE",
            sizeof(dm.m_network.m_net_info.id) - 1);
    dm.m_network.m_net_info.id[sizeof(dm.m_network.m_net_info.id) - 1] = '\0';
    ...
    EXPECT_EQ(cmd.m_svc, em_service_type_none);
 ...
 * | 04 | Log a warning message indicating that the command parameters are empty as expected in this negative test scenario. | Log message: "Warning: Command parameters are empty - expected for negative test" | The warning is logged correctly for the negative test scenario. | Should be successful |
 */
TEST(em_cmd_cfg_renew_t, em_cmd_cfg_renew_t_negative_empty_param)
{
    ...
    dm_easy_mesh_t dm{};
    strncpy(dm.m_network.m_net_info.id, "NetworkID_EmptyParam",
            sizeof(dm.m_network.m_net_info.id) - 1);
    dm.m_network.m_net_info.id[sizeof(dm.m_network.m_net_info.id) - 1] = '\0';
    ...
    std::cout << "Warning: Command parameters are empty - expected for negative test" << std::endl;
    std::cout << "Exiting " << testName << " test" << std::endl;
}
 ...
 * | 05 | Log warning about the incomplete network configuration. | Logged message: "Warning: dm_easy_mesh_t has incomplete network configuration (empty network id)" | Warning message is printed indicating incomplete network configuration. | Should be successful |
 * | 06 | Log the test exit message. | Logged message: "Exiting em_cmd_cfg_renew_t_negative_dm_error test" | Exit message is printed. | Should be successful |
 */
TEST(em_cmd_cfg_renew_t, em_cmd_cfg_renew_t_negative_dm_error)
{
    ...
    em_service_type_t service = em_service_type_agent;
    em_cmd_params_t parameters = {};
    strncpy(parameters.u.args.fixed_args, "ValidAgentParam",
            sizeof(parameters.u.args.fixed_args) - 1);
    parameters.u.args.fixed_args[sizeof(parameters.u.args.fixed_args) - 1] = '\0';
    parameters.u.args.num_args = 1;
    ...
    std::cout << "Warning: dm_easy_mesh_t has incomplete network configuration (empty network id)" << std::endl;
    std::cout << "Exiting " << testName << " test" << std::endl;
}
