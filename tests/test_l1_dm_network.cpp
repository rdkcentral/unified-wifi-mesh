...
TEST(dm_network_t_Test, CopyConstructorWithValidNetworkObject) {
    ...
    ASSERT_STREQ(copied_net.m_net_info.id, original_net.m_net_info.id);
    ASSERT_EQ(copied_net.m_net_info.num_of_devices, 5);
    ASSERT_STREQ(copied_net.m_net_info.timestamp, "2024-12-25T10:30:00Z");
    ASSERT_STREQ(copied_net.m_net_info.ctrl_id.name, "ctrl_intf");
    ASSERT_EQ(memcmp(copied_net.m_net_info.ctrl_id.mac, ctrl_mac, sizeof(mac_address_t)), 0);
    ASSERT_EQ(copied_net.m_net_info.ctrl_id.media, em_media_type_ieee80211ac_5);
    ASSERT_EQ(copied_net.m_net_info.num_mscs_disallowed_sta, 2);
    ASSERT_STREQ(copied_net.m_net_info.mscs_disallowed_sta[0], "sta1");
    ASSERT_STREQ(copied_net.m_net_info.mscs_disallowed_sta[1], "sta2");
    ASSERT_EQ(copied_net.m_net_info.num_scs_disallowed_sta, 3);
    ASSERT_STREQ(copied_net.m_net_info.scs_disallowed_sta[0], "bss1");
    ASSERT_STREQ(copied_net.m_net_info.scs_disallowed_sta[1], "bss2");
    ASSERT_STREQ(copied_net.m_net_info.scs_disallowed_sta[2], "bss3");
    ASSERT_STREQ(copied_net.m_net_info.colocated_agent_id.name, "agent_intf");
    ASSERT_EQ(memcmp(copied_net.m_net_info.colocated_agent_id.mac, coloc_mac, sizeof(mac_address_t)), 0);
    ASSERT_EQ(copied_net.m_net_info.colocated_agent_id.media, em_media_type_ieee80211ac_5);
    ASSERT_EQ(copied_net.m_net_info.media, em_media_type_ieee80211ac_5);
...
TEST(dm_network_t_Test, ValidNetworkInformation) {
    ...
    ASSERT_STREQ(network.m_net_info.id, "network_id");
    ASSERT_EQ(network.m_net_info.num_of_devices, 5);
    ASSERT_STREQ(network.m_net_info.timestamp, "2025-01-01T00:00:00Z");
    ASSERT_STREQ(network.m_net_info.ctrl_id.name, "interface_name");
    ASSERT_EQ(memcmp(network.m_net_info.ctrl_id.mac, mac_ctrl, sizeof(mac_address_t)), 0);
    ASSERT_EQ(network.m_net_info.ctrl_id.media, em_media_type_ieee80211n_24);
    ASSERT_EQ(network.m_net_info.num_mscs_disallowed_sta, 2);
    ASSERT_STREQ(network.m_net_info.mscs_disallowed_sta[0], "sta1");
    ASSERT_STREQ(network.m_net_info.mscs_disallowed_sta[1], "sta2");
    ASSERT_EQ(network.m_net_info.num_scs_disallowed_sta, 3);
    ASSERT_STREQ(network.m_net_info.scs_disallowed_sta[0], "sta3");
    ASSERT_STREQ(network.m_net_info.scs_disallowed_sta[1], "sta4");
    ASSERT_STREQ(network.m_net_info.scs_disallowed_sta[2], "sta5");
    ASSERT_STREQ(network.m_net_info.colocated_agent_id.name, "agent_name");
    ASSERT_EQ(memcmp(network.m_net_info.colocated_agent_id.mac, mac_coloc, sizeof(mac_address_t)), 0);
    ASSERT_EQ(network.m_net_info.colocated_agent_id.media, em_media_type_ieee80211n_24);
    ASSERT_EQ(network.m_net_info.media, em_media_type_ieee80211n_24);
...
*/
/*invalid mac address not permitted - doubt
TEST(dm_network_t_Test, InvalidMACAddressInControllerInterface) {
    ...
    em_network_info_t invalid_mac_net_info = { "network_id", 5, "timestamp", {"interface_name", {0x00, 0x1A, 0x2B, 0x3C, 0x4D}, em_media_type_ieee80211n_24}, 2, {"sta1", "sta2"}, 3, {"sta3", "sta4", "sta5"}, {"agent_name", {0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E}, em_media_type_ieee80211n_24}, em_media_type_ieee80211n_24 };
...
*/
/*invalid media type not permitted not part of enum - doubt
TEST(dm_network_t_Test, InvalidMediaTypeInControllerInterface) {
    std::cout << "Entering InvalidMediaTypeInControllerInterface test";
    em_network_info_t invalid_media_net_info = { "network_id", 5, "timestamp", {"interface_name", {0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E}, (em_media_type_t)999}, 2, {"sta1", "sta2"}, 3, {"sta3", "sta4", "sta5"}, {"agent_name", {0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E}, em_media_type_ieee80211n_24}, em_media_type_ieee80211n_24 };
...
*/
/*passing empty timestamp - doubt
TEST(dm_network_t_Test, InvalidTimestamp) {
    std::cout << "Entering InvalidTimestamp test";
    em_network_info_t invalid_timestamp_net_info = { "network_id", 5, "", {"interface_name", {0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E}, em_media_type_ieee80211n_24}, 2, {"sta1", "sta2"}, 3, {"sta3", "sta4", "sta5"}, {"agent_name", {0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E}, em_media_type_ieee80211n_24}, em_media_type_ieee80211n_24 };
...
*/
/*code doesn't handle null
TEST_F(dm_network_t_Test, EncodeWithValidCJsonObjectAndSummaryFalse) {
...
TEST(dm_network_t_Test, EncodeWithCJsonObjectMultipleChildrenAndSummaryTrue) {
    ...
    cJSON *child2 = cJSON_CreateString("child2_value");
    cJSON_AddItemToObject(obj, "child1", child1);
    cJSON_AddItemToObject(obj, "child2", child2);
    dm_network_t network;
    network.encode(obj, true);
    cJSON *summary = cJSON_GetObjectItem(obj, "summary");
    ASSERT_NE(summary, nullptr); // Make sure "summary" key exists
    ASSERT_TRUE(cJSON_IsBool(summary)); // Ensure it's a boolean
    ASSERT_TRUE(cJSON_IsTrue(summary)); // Ensure its value is true
...
TEST(dm_network_t_Test, EncodeWithCJsonObjectInvalidTypeAndSummaryFalse) {
    cJSON *obj = cJSON_CreateObject();
    if (obj != nullptr) {
        obj->type = -1;  // Simulate invalid type
        dm_network_t network;
        try {
            network.encode(obj, false);  // Assuming encode() handles invalid cJSON gracefully
            SUCCEED();
        } catch (...) {
            FAIL() << "encode() threw an exception on invalid cJSON input";
        }
        cJSON_Delete(obj);
    } else {
        FAIL() << "Failed to allocate cJSON object";
    }
}
...
TEST(dm_network_t_Test, RetrieveColocatedAgentInterfaceName_ValidString) {
    ...
    ASSERT_STREQ(result, "agent_interface_1");
...
TEST(dm_network_t_Test, RetrieveControllerInterfaceWhenNetworkInfoIsProperlyInitialized) {
    ...
    ASSERT_NE(controller_interface, nullptr);
...
TEST(dm_network_t_Test, RetrieveNetworkID_ValidString) {
    ...
    ASSERT_STREQ(result, "valid_network_id");
...
TEST(dm_network_t_Test, RetrieveNetworkInfoAfterSettingAllFields) {
    ...
    ASSERT_STREQ(info->id, "test_network");
    ASSERT_EQ(info->num_of_devices, 1);
    ASSERT_STREQ(info->timestamp, "2025-05-27T14:00:00Z");
    ASSERT_STREQ(info->ctrl_id.name, "ctrl_intf");
    ASSERT_EQ(memcmp(info->ctrl_id.mac, ctrl_mac, sizeof(ctrl_mac)), 0);
    ASSERT_EQ(info->ctrl_id.media, em_media_type_ieee80211ac_5);
    ASSERT_EQ(info->num_mscs_disallowed_sta, 2);
    ASSERT_STREQ(info->mscs_disallowed_sta[0], "sta1");
    ASSERT_STREQ(info->mscs_disallowed_sta[1], "sta2");
    ASSERT_EQ(info->num_scs_disallowed_sta, 3);
    ASSERT_STREQ(info->scs_disallowed_sta[0], "bss1");
    ASSERT_STREQ(info->scs_disallowed_sta[1], "bss2");
    ASSERT_STREQ(info->scs_disallowed_sta[2], "bss3");
    ASSERT_STREQ(info->colocated_agent_id.name, "agent0");
    ASSERT_EQ(memcmp(info->colocated_agent_id.mac, agent_mac, sizeof(agent_mac)), 0);
    ASSERT_EQ(info->colocated_agent_id.media, em_media_type_ieee80211ac_5);
    ASSERT_EQ(info->media, em_media_type_ieee80211ac_5);
...
*/
TEST(dm_network_tTest, AssigningValidObject) {
    ...
    obj1 = obj2;
    ASSERT_EQ(obj1.m_net_info.num_of_devices, obj2.m_net_info.num_of_devices);
    ASSERT_STREQ(obj1.m_net_info.id, obj2.m_net_info.id);
...
*/
TEST(dm_network_tTest, CompareIdenticalObjects) {
...
*/
TEST(dm_network_tTest, CompareDifferentNetworkIDs) {
...
*/
TEST(dm_network_tTest, CompareDifferentNumberOfDevices) {
...
*/
TEST(dm_network_tTest, CompareDifferentControllerMACAddresses) {
...
* | 04 | Compare obj1 and obj2 for equality | obj1 == obj2 | EXPECT_FALSE(obj1 == obj2) | Should Pass |
*/
TEST(dm_network_tTest, CompareDifferentMediaTypes) {
...
*/
TEST(dm_network_tTest, CompareDifferentColocatedAgentMACAddresses) {
...
* | 04| Compare obj1 and obj2 for equality | obj1 == obj2 | EXPECT_FALSE(obj1 == obj2) | Should Pass |
*/
TEST(dm_network_tTest, CompareDifferentColocatedAgentNames) {
...
*/
TEST(dm_network_tTest, CompareDifferentTimestamps) {
...
*/
TEST(dm_network_tTest, CompareDifferentNumMSCSDisallowedSta) {
...
*/
TEST(dm_network_tTest, CompareDifferentNumSCSDisallowedSta) {
...
TEST(dm_network_t_Test, ValidColocatedAgentMACAddress) {
    ...
    // Access struct member directly to verify
    for (int i = 0; i < 6; ++i) {
...
TEST(dm_network_t_Test, InvalidLengthColocatedAgentMACAddress) {
    ...
    unsigned char mac[] = {0x00, 0x1A, 0x2B};
    dm_network_t network;
    network.set_colocated_agent_interface_mac(mac);
    unsigned char* result = network.m_net_info.colocated_agent_id.mac; // direct access
    for (int i = 0; i < 6; ++i) {
        if (i < 3) {
...
TEST(dm_network_t_Test, SetValidNameForColocatedAgentInterface) {
    ...
    ASSERT_STREQ(network.m_net_info.colocated_agent_id.name, name);
...
TEST(dm_network_t_Test, InvalidLengthControllerMACAddress) {
    std::cout << "Entering InvalidLengthControllerMACAddress test";
    unsigned char mac[] = {0x00, 0x1A, 0x2B};
    dm_network_t network;
    network.set_controller_id(mac);
    unsigned char* result = network.m_net_info.ctrl_id.mac;
    ...
    std::cout << "Exiting InvalidLengthControllerMACAddress test";
}
 ...
 */
TEST(dm_network_test, SetVariousMediaTypes) {
    ...
    for (const auto& test : media_types) {
        ...
        ASSERT_EQ(network.m_net_info.media, test.media) << "Failed for media type: " << test.name;
    }
...
*/
TEST(dm_network_test, SetMediaTypeToInvalidValue) {
    std::cout << "Entering SetMediaTypeToInvalidValue test";
    dm_network_t network;
    network.set_controller_intf_media(static_cast<em_media_type_t>(0x9999));
