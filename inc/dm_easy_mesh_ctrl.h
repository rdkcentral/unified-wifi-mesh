...
public:
	 ...
	 * @param[out] pcmd Command array to append client assoc ctrl req commands to.
	 * @param[in] start_num Index in pcmd at which to append new commands.
	 *
	 * @returns number of client assoc ctrl req commands appended.
	 */
	int build_steer_cac_block_params(const em_cmd_steer_params_t &steer, em_cmd_t *pcmd[], int start_num);
