...
public:
     ...
     */
    int refresh_onewifi_subdoc(wifi_bus_desc_t *desc, bus_handle_t *bus_hdl,
                                                     const char* logname, webconfig_subdoc_type_t type, 
                                                     m2ctrl_radioconfig *m2_cfg=NULL, em_policy_cfg_params_t *policy_config=NULL);
