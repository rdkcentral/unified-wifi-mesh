 ...
 * EM_MAX_CAC_OP_CLASS_PER_METHOD × sizeof == 144 bytes, preserving
...
typedef struct {
    ...
    // unsigned char   serial[MAP_INVENTORY_ITEM_LEN];//reuse from em_device_info_tserial_number
...
typedef struct {
    ...
    unsigned char   op_classes_num;
    em_cac_op_class_t  op_classes[EM_MAX_CAC_OP_CLASS_PER_METHOD];
...
typedef struct {
    ...
    // em_device_inventory_t inventory_info;//move to device
