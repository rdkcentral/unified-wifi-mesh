...
#define DE_DEVICE_BOOTID        DE_NETWORK_DEVICE       "X_AIRTIES_BootID"
#define DE_DEVICE_CLIENTID      DE_NETWORK_DEVICE       "X_AIRTIES_ClientID"
#define DE_DEVICE_CLIENTSECRET  DE_NETWORK_DEVICE       "X_AIRTIES_ClientSecret"
